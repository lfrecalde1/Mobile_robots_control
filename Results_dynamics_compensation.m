...
%% Data generation
control1_plot = line(t,u_ref(1,:));
set(control1_plot, 'LineStyle', '-', 'Color', c4, 'LineWidth', lw);
control2_plot = line(t,u_ref(2,:));
...
%% Legend nomeclature
hLegend_5 = legend([control1_plot,control2_plot],{'$\mu_{ref}$','$\omega_{ref}$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
export_fig Results_Dynamics_Compensation.pdf -q101